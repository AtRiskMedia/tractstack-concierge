...
function postSettings($payload)
{
  ...
  $frontend_keys = ["PRIVATE_SHOPIFY_STOREFRONT_ACCESS_TOKEN","PUBLIC_SHOPIFY_SHOP","PUBLIC_SHOPIFY_STOREFRONT_ACCESS_TOKEN","PRIVATE_CONCIERGE_BASE_URL","PUBLIC_CONCIERGE_STYLES_URL",
    "PUBLIC_SITE_URL","PUBLIC_IMAGE_URL","PUBLIC_SOCIALS","PUBLIC_FOOTER","PUBLIC_HOME","PUBLIC_TRACTSTACK","PUBLIC_IMPRESSIONS_DELAY","PUBLIC_SLOGAN","PRIVATE_OPEN_DEMO","PUBLIC_BRAND","PUBLIC_LOGO","PUBLIC_WORDMARK","PUBLIC_OG",
